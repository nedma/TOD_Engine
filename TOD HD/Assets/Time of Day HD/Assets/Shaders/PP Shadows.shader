Shader "Hidden/Time of Day/Cloud Shadows"
{
	...
	{
		half4 sceneColor = tex2D(_MainTex, HTOD_UV(i.uv, _MainTex_ST));
		...
		a *= smoothstep(HTOD_CloudShadowCutoff, HTOD_CloudShadowCutoff + HTOD_CloudShadowFade, Luminance(sceneColor.rgb)) * HTOD_CloudShadowIntensity;
