...
[ExecuteInEditMode]
public class HTOD_Components : MonoBehaviour
{
	/// Space object.
	...
	/// Dome sky script.
	public HTOD_Sky Sky { get; set; }

	/// Dome animation script.
	public HTOD_Animation Animation { get; set; }

	/// Dome time script.
	public HTOD_Time Time { get; set; }

	/// Camera script.
	public HTOD_Camera Camera { get; set; }

	/// Camera god ray script.
	public HTOD_Rays Rays { get; set; }

	/// Camera atmospheric scattering script.
	public HTOD_Scattering Scattering { get; set; }

	/// Camera cloud shadow script.
	public HTOD_Shadows Shadows { get; set; }
	...
	public void Initialize()
	{
		...
		Sky       = GetComponent<HTOD_Sky>();
		Animation = GetComponent<HTOD_Animation>();
		Time      = GetComponent<HTOD_Time>();
