...
[Serializable] public class HTOD_Parameters
{
	...
	public HTOD_Parameters()
	{
	}

	public HTOD_Parameters(HTOD_Sky sky)
	{
		Cycle      = sky.Cycle;
		World      = sky.World;
	...
	public void ToSky(HTOD_Sky sky)
	{
		sky.Cycle      = Cycle;
		sky.World      = World;
...
/// This is the type of the HTOD_Sky.Cycle inspector variable group.
[Serializable] public class HTOD_CycleParameters
{
	/// [0, 24]
	...
	[HTOD_Range(1, 9999)] public int Year = 2000;
...
/// This is the type of the HTOD_Sky.World inspector variable group.
[Serializable] public class HTOD_WorldParameters
{
	/// [-90, +90]
...
[Serializable] public class HTOD_AtmosphereParameters
{
	...
	[HTOD_Range(0f, 1f)] public float Directionality = 0.7f;

	/// [0, 1]
	/// Density of the fog covering the sky.
	[Tooltip("Density of the fog covering the sky.")]
	[HTOD_Range(0f, 1f)] public float Fogginess = 0.0f;
}

/// Parameters that are unique to the day.
/// This is the type of the HTOD_Sky.Day inspector variable group.
[Serializable] public class HTOD_DayParameters
{
...
/// This is the type of the HTOD_Sky.Night inspector variable group.
[Serializable] public class HTOD_NightParameters
{
...
/// This is the type of the HTOD_Sky.Sun inspector variable group.
[Serializable] public class HTOD_SunParameters
{
	/// [0, &infin;]
	/// Diameter of the sun in degrees.
	/// The diameter as seen from earth is 0.5 degrees.
	[Tooltip("Diameter of the sun in degrees.\nThe diameter as seen from earth is 0.5 degrees.")]
	[HTOD_Min(0f)] public float MeshSize = 1.0f;

	/// [0, &infin;]
	/// Brightness of the sun.
	[Tooltip("Brightness of the sun.")]
	[HTOD_Min(0f)] public float MeshBrightness = 2.0f;

	/// [0, &infin;]
	/// Contrast of the sun.
	[Tooltip("Contrast of the sun.")]
	[HTOD_Min(0f)] public float MeshContrast = 1.0f;
}

/// Parameters that are unique to the moon.
/// This is the type of the HTOD_Sky.Moon inspector variable group.
[Serializable] public class HTOD_MoonParameters
{
	/// [0, &infin;]
	...
	[HTOD_Min(0f)] public float HaloSize = 0.1f;

	/// [0, &infin;]
	/// Brightness of the moon halo.
	[Tooltip("Brightness of the moon halo.")]
	[HTOD_Min(0f)] public float HaloBrightness = 1.0f;

	/// Type of the moon position calculation.
	[Tooltip("Type of the moon position calculation.")]
	public HTOD_MoonPositionType Position = HTOD_MoonPositionType.Realistic;
}

/// Parameters of the stars.
/// This is the type of the HTOD_Sky.Stars inspector variable group.
[Serializable] public class HTOD_StarParameters
{
	/// [0, &infin;]
	/// Size of the stars.
	[Tooltip("Size of the stars.")]
	[HTOD_Min(0f)] public float Size = 1.0f;

	/// [0, &infin;]
	/// Brightness of the stars.
	[Tooltip("Brightness of the stars.")]
	[HTOD_Min(0f)] public float Brightness = 1.0f;

	/// Type of the stars position calculation.
	[Tooltip("Type of the stars position calculation.")]
	public HTOD_StarsPositionType Position = HTOD_StarsPositionType.Rotating;
}

/// Parameters of the clouds.
/// This is the type of the HTOD_Sky.Clouds inspector variable group.
[Serializable] public class HTOD_CloudParameters
{
	/// [1, &infin;]
	/// Size of the clouds.
	[Tooltip("Size of the clouds.")]
	[HTOD_Min(1f)] public float Size = 2.0f;

	/// [0, 1]
	/// Opacity of the clouds.
	[Tooltip("Opacity of the clouds.")]
	[HTOD_Range(0f, 1f)] public float Opacity = 1.0f;

	/// [0, 1]
	/// How much sky is covered by clouds.
	[Tooltip("How much sky is covered by clouds.")]
	[HTOD_Range(0f, 1f)] public float Coverage = 0.5f;

	/// [0, 1]
	/// Sharpness of the cloud to sky transition.
	[Tooltip("Sharpness of the cloud to sky transition.")]
	[HTOD_Range(0f, 1f)] public float Sharpness = 0.5f;

	/// [0, 1]
	/// Coloring of the clouds.
	[Tooltip("Coloring of the clouds.")]
	[HTOD_Range(0f, 1f)] public float Coloring = 0.5f;

	/// [0, 1]
	/// Amount of skylight that is blocked.
	[Tooltip("Amount of skylight that is blocked.")]
	[HTOD_Range(0f, 1f)] public float Attenuation = 0.5f;
...
/// This is the type of the HTOD_Sky.Light inspector variable group.
[Serializable] public class HTOD_LightParameters
{
	/// [0, &infin;]
	/// Refresh interval of the light source position in seconds.
	[Tooltip("Refresh interval of the light source position in seconds.")]
	[HTOD_Min(0f)] public float UpdateInterval = 0.0f;
	...
	[HTOD_Range(-1f, 1f)] public float MinimumHeight = 0.0f;
}

/// Parameters of the fog mode.
/// This is the type of the HTOD_Sky.Fog inspector variable group.
[Serializable] public class HTOD_FogParameters
{
	/// Fog color mode.
	[Tooltip("Fog color mode.")]
	public HTOD_FogType Mode = HTOD_FogType.Atmosphere;
	...
	[HTOD_Range(0f, 1f)] public float HeightBias = 0.0f;
}

/// Parameters of the ambient mode.
/// This is the type of the HTOD_Sky.Ambient inspector variable group.
[Serializable] public class HTOD_AmbientParameters
{
	/// Ambient light mode.
	[Tooltip("Ambient light mode.")]
	public HTOD_AmbientType Mode = HTOD_AmbientType.Color;

	/// Saturation of the ambient light.
	[Tooltip("Saturation of the ambient light.")]
	[HTOD_Min(0f)] public float Saturation = 1.0f;

	/// Refresh interval of the ambient light probe in seconds.
	[Tooltip("Refresh interval of the ambient light probe in seconds.")]
	[HTOD_Min(0f)] public float UpdateInterval = 1.0f;
}

/// Parameters of the reflection mode.
/// This is the type of the HTOD_Sky.Reflection inspector variable group.
[Serializable] public class HTOD_ReflectionParameters
{
	/// Reflection probe mode.
	[Tooltip("Reflection probe mode.")]
	public HTOD_ReflectionType Mode = HTOD_ReflectionType.None;
	...
	[HTOD_Range(16, 2048)] public int Resolution = 128;
