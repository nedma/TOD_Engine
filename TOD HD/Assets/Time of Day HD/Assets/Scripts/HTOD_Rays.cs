...
/// Extended to get the god ray color from HTOD_Sky and properly handle transparent meshes like clouds.

[ExecuteInEditMode]
[RequireComponent(typeof(Camera))]
[AddComponentMenu("Time of Day/Camera God Rays")]
public class HTOD_Rays : HTOD_ImageEffect
{
	...
	[HTOD_Min(0f)] public float Intensity = 1;
	...
	[HTOD_Min(0f)] public float MaxRadius = 0.5f;
