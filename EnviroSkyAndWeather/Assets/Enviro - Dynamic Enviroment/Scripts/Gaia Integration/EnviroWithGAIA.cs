...
namespace Gaia.GX.HendrikHaupt
{
	...
	public class EnviroWithGAIA : MonoBehaviour
	{
		...
		{
			return "Enviro - Dynamic Environment";
		}
		...
		{
			EditorUtility.DisplayDialog("About Enviro - Dynamic Environment", "Enviro - Dynamic Environment simulates day-night cycle, clouds, weather and seasons!", "OK");
		}
