...
using UnityEngine;
	...
	[HideInInspector]public SunShaftsResolution resolution = SunShaftsResolution.Normal;
	[HideInInspector]public ShaftsScreenBlendMode screenBlendMode = ShaftsScreenBlendMode.Screen;
	...
	[HideInInspector]public Color sunThreshold = new Color(0.87f,0.74f,0.65f);
	[HideInInspector]public float sunShaftBlurRadius = 2.5f;
	[HideInInspector]public float sunShaftIntensity = 1.15f;

	[HideInInspector]public float maxRadius = 0.75f;

	[HideInInspector]public bool  useDepthTexture = true;

	[HideInInspector]public Shader sunShaftsShader;
	[HideInInspector]public Material sunShaftsMaterial;

	[HideInInspector]public Shader simpleClearShader;
	[HideInInspector]public Material simpleClearMaterial;
