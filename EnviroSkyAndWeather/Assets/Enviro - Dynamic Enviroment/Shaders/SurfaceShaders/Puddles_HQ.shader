...
Shader "Enviro/Puddles_HQ" {
    Properties {
        _Depth ("Depth", Range(0, 1)) = 1
        _WetNormal ("WetNormal", 2D) = "bump" {}
        _Gloss ("Gloss", Range(0, 1)) = 1
        _Alpha ("Alpha", Range(0, 1)) = 1
        _Ripple ("Ripple", 2D) = "bump" {}
    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 node_4532_nrm_detail = _Ripple_var.rgb * float3(-1,-1,1);
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float3 diffColor = _LightColor0.rgb;
