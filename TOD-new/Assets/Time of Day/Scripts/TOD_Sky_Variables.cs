...
public partial class TOD_Sky : MonoBehaviour
{
    ...
    /// Inspector variable containing parameters of the cloud pbr layers.
    public TOD_CloudPBRParameters CloudsPbr;
    ...
    /// The ambient light color sampled from the physical model.
    /// Depends on the time of day.
    /// This property is O(1) if TOD_WorldParameters.SetAmbientLight is enabled as its value will be calculated anyhow.
    internal Color AmbientColor
    {
        get { return World.SetAmbientLight ? RenderSettings.ambientLight : SampleAmbientColor(); }
    }
